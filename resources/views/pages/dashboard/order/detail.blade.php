                                    ...
                                    <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                                        ...
                                        <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                            <div class="flex mt-2 flex-nowrap">
                                                <img :class="{'border-4 border-serv-button': active === 1}" @click="changeThumbnail('{{ url('https://source.unsplash.com/_SgRNwAVNKw/1600x900/') }}',1)" src="{{ url('https://source.unsplash.com/_SgRNwAVNKw/250x160/') }}" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 2}" @click="changeThumbnail('{{ url('https://source.unsplash.com/GXNo-OJynTQ/1600x900/') }}',2)" src="{{ url('https://source.unsplash.com/GXNo-OJynTQ/250x160/') }}" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 3}" @click="changeThumbnail('{{ url('https://source.unsplash.com/x-HpilsdKEk/1600x900/') }}',3)" src="{{ url('https://source.unsplash.com/x-HpilsdKEk/250x160/') }}" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 4}" @click="changeThumbnail('{{ url('https://source.unsplash.com/hLit2zL-Dhk/1600x900/') }}',4)" src="{{ url('https://source.unsplash.com/hLit2zL-Dhk/250x160/') }}" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 5}" @click="changeThumbnail('{{ url('https://source.unsplash.com/i1VQZsU86ok/1600x900/') }}',5)" src="{{ url('https://source.unsplash.com/i1VQZsU86ok/250x160/') }}" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 6}" @click="changeThumbnail('{{ url('https://source.unsplash.com/iEiUITs149M/1600x900/') }}',6)" src="{{ url('https://source.unsplash.com/iEiUITs149M/250x160/') }}" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                            </div>
                                        </div>
